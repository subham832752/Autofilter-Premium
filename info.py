...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003657766368'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002585670955'))  # Bin channel id (make sure bot is admin)
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+YeYUfkpUcPs3MTNl')  # Support group link (make sure bot is admin)
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'subhammana@fam')    # Owner UPI ID for payments
...
# ============================
DATABASE_URL = environ.get('DATABASE_URL', "")  # MongoDB URL for the database
...
SHORTENER_API = environ.get("SHORTENER_API", "8ec98008310016c6c90339b8c5e4b4f216a80df9") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "https://api.linkshortify.com") # Shortener website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+zVjhTE2WyRFjNmFl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/subham832752') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+YeYUfkpUcPs3MTNl') # Update channel link for the bot
